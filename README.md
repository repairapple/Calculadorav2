...
- ✨ Design moderno inspirado na calculadora da Apple
- 🔢 Formatação automática de números com separadores de milhares (padrão brasileiro)
- 🎨 Interface escura elegante com botões circulares
...
**Nota: esta é uma operação irreversível. Uma vez que você execute `eject`, não há como voltar!**

Se você não estiver satisfeito com a ferramenta de construção e as opções de configuração, você pode executar `eject` a qualquer momento. Este comando removerá a dependência de construção única do seu projeto.
